#############################################################################
# Makefile for building: routing
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  ../routing/routing.pro
# Template: app
# Command: /opt/Qt5.3.2/5.3/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile ../routing/routing.pro
#############################################################################
...
INCPATH       = -I/opt/Qt5.3.2/5.3/gcc_64/mkspecs/linux-g++ -I../routing -I/opt/Qt5.3.2/5.3/gcc_64/include -I/opt/Qt5.3.2/5.3/gcc_64/include/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-rpath,/opt/Qt5.3.2/5.3/gcc_64 -Wl,-rpath,/opt/Qt5.3.2/5.3/gcc_64/lib
LIBS          = $(SUBLIBS) -L/opt/Qt5.3.2/5.3/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /opt/Qt5.3.2/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../routing/routing.pro ../pa4/main.cpp \
		../pa4/parser.cpp \
		../pa4/routingdb.cpp \
		../pa4/tree.cpp \
		../pa4/lib/mst.cpp
QMAKE_TARGET  = routing
...
Makefile: ../routing/routing.pro /opt/Qt5.3.2/5.3/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.3.2/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.3.2/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt5.3.2/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.3.2/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.3.2/5.3/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile ../routing/routing.pro
...
dist: 
	@test -d .tmp/routing1.0.0 || mkdir -p .tmp/routing1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/routing1.0.0/ && $(COPY_FILE) --parents ../pa4/routingdb.h ../pa4/tree.h ../pa4/parser.h ../pa4/lib/mst.h .tmp/routing1.0.0/ && $(COPY_FILE) --parents ../pa4/main.cpp ../pa4/parser.cpp ../pa4/routingdb.cpp ../pa4/tree.cpp ../pa4/lib/mst.cpp .tmp/routing1.0.0/ && (cd `dirname .tmp/routing1.0.0` && $(TAR) routing1.0.0.tar routing1.0.0 && $(COMPRESS) routing1.0.0.tar) && $(MOVE) `dirname .tmp/routing1.0.0`/routing1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/routing1.0.0
...
main.o: ../pa4/main.cpp ../pa4/parser.h \
		../pa4/routingdb.h \
		../pa4/tree.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../pa4/main.cpp

parser.o: ../pa4/parser.cpp ../pa4/parser.h \
		../pa4/routingdb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o parser.o ../pa4/parser.cpp

routingdb.o: ../pa4/routingdb.cpp ../pa4/routingdb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o routingdb.o ../pa4/routingdb.cpp

tree.o: ../pa4/tree.cpp ../pa4/lib/mst.h \
		../pa4/routingdb.h \
		../pa4/tree.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tree.o ../pa4/tree.cpp

mst.o: ../pa4/lib/mst.cpp ../pa4/lib/mst.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mst.o ../pa4/lib/mst.cpp
